 ...
 */
class BundleItems extends \Magento\Sales\Block\Order\Email\Items\Order\DefaultOrder
{
    /**
    ...
    {
        if($this->getItem()->getProductId()) {
            return  $this->_productRepository->getById($this->getItem()->getProductId());
        } else {
